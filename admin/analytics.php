...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" style="color:rgb(122, 92, 84);"><b>Meal</b> <b style="color:rgb(231, 205, 171);">Share</b><span>Together, We Can End Hunger</span></p>
             <p class="user"></p>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    <i class="uil uil-chart"></i>
                    <span class="text" style="color:rgb(67, 62, 61);">Contributions</span>
                </div>
...
<script>
      <?php
            ...
            $q3="SELECT count(*) as count FROM food_donations where location=\"Bengaluru\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $Bengaluru=$ro3['count'];

            $q4="SELECT count(*) as count FROM food_donations where location=\"Udupi\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $Udupi=$ro4['count'];

            $q5="SELECT count(*) as count FROM food_donations where location=\"Mysuru\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $Mysuru=$ro5['count'];

            
            $q6="SELECT count(*) as count FROM food_donations where location=\"Tumkuru\"";
            $res6=mysqli_query($connection, $q6);
            $ro6=mysqli_fetch_assoc($res6);
            $Tumkuru=$ro6['count'];

            $q7="SELECT count(*) as count FROM food_donations where location=\"Kolar\"";
            $res7=mysqli_query($connection, $q7);
            $ro7=mysqli_fetch_assoc($res7);
            $Kolar=$ro7['count'];

            $q8="SELECT count(*) as count FROM food_donations where location=\"Mangaluru\"";
            $res8=mysqli_query($connection, $q8);
            $ro8=mysqli_fetch_assoc($res8);
            $Mangaluru=$ro8['count'];

            $q9="SELECT count(*) as count FROM food_donations where location=\"Haveri\"";
...
var xplace=["Bengaluru","Udupi","Mysuru","Tumkuru","Kolar","Mangaluru","Haveri"];
var yplace=[<?php echo json_encode($Bengaluru,JSON_HEX_TAG);?>,<?php echo json_encode($Udupi,JSON_HEX_TAG);?>,<?php echo json_encode($Mysuru,JSON_HEX_TAG);?>];
