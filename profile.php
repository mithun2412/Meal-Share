...
<body>
<header>
<div class="logo"><b>Meal </b><b class="meal" style="color:rgb(231, 205, 171);">Share </b>
          <span>Together, We Can End Hunger</span>
          </div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
    ...
    <!-- <section class="cover" >
        ...
        <div class="profilebox" style="">
            ...
            <!-- <br> 
              ...
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: rgb(122, 92, 84); color: white;padding: ;padding-left: 10px;padding-right: 10px;">Logout</a>
              </div>
              <br>
              <br>
